                        ...
                        <div class="form-section mb-4">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="event_name" name="event_name" required>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-lg" id="event_start_date" name="start_date" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-lg" id="event_end_date" name="end_date" required>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="event_location" name="location" required>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <select class="form-select form-select-lg" id="event_assigned_users" name="assigned_users[]" multiple>
